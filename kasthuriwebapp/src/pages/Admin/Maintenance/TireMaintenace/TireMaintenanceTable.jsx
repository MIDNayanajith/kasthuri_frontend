...
const TireMaintenanceTable = ({
  tireMaintenanceRecords,
  onEditTireMaintenance,
  onDeleteTireMaintenance,
  loading,
  isAdmin,
}) => {
  if (loading) {
            ...
            {tireMaintenanceRecords.length === 0 ? (
              <tr>
                ...
                >
                  ...
                  <p className="text-lg font-medium text-gray-400">
                    No tire maintenance records found
                  </p>
                  <p className="text-sm text-gray-400 mt-1">
                    Get started by adding your first tire maintenance record
                  </p>
                </td>
              </tr>
            ) : (
              tireMaintenanceRecords.map((record) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap block md:table-cell relative md:static before:content-['Position'] before:font-semibold before:text-xs before:uppercase before:text-gray-600 before:absolute before:left-6 before:top-2 md:before:hidden">
                    <div className="flex items-center text-sm text-gray-900 pt-6 md:pt-0">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap block md:table-cell relative md:static before:content-['Tire_Brand'] before:font-semibold before:text-xs before:uppercase before:text-gray-600 before:absolute before:left-6 before:top-2 md:before:hidden">
                    <div className="flex items-center text-sm text-gray-900 pt-6 md:pt-0">
                      {record.tireBrand || "N/A"}
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap block md:table-cell relative md:static before:content-['Tire_Size'] before:font-semibold before:text-xs before:uppercase before:text-gray-600 before:absolute before:left-6 before:top-2 md:before:hidden">
                    <div className="flex items-center text-sm text-gray-900 pt-6 md:pt-0">
                      {record.tireSize || "N/A"}
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap block md:table-cell relative md:static before:content-['Serial_No.'] before:font-semibold before:text-xs before:uppercase before:text-gray-600 before:absolute before:left-6 before:top-2 md:before:hidden">
                    <div className="flex items-center text-sm text-gray-900 pt-6 md:pt-0">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap block md:table-cell relative md:static before:content-['Unit_Price'] before:font-semibold before:text-xs before:uppercase before:text-gray-600 before:absolute before:left-6 before:top-2 md:before:hidden">
                    <div className="flex items-center text-sm text-gray-900 pt-6 md:pt-0">
                      ...
                      {record.unitPrice ? `$${record.unitPrice}` : "N/A"}
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap block md:table-cell relative md:static before:content-['Total_Price'] before:font-semibold before:text-xs before:uppercase before:text-gray-600 before:absolute before:left-6 before:top-2 md:before:hidden">
                    <div className="flex items-center text-sm text-gray-900 pt-6 md:pt-0">
                      <DollarSign className="w-4 h-4 mr-2 text-gray-400" />
                      {record.totalPrice ? `$${record.totalPrice}` : "N/A"}
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium block md:table-cell relative md:static before:content-['Actions'] before:font-semibold before:text-xs before:uppercase before:text-gray-600 before:absolute before:left-6 before:top-2 md:before:hidden pb-6 md:pb-4">
                    <div className="flex items-center space-x-2 pt-6 md:pt-0">
                      <button
                        onClick={() => onEditTireMaintenance(record)}
                      ...
                      {isAdmin && (
                        <button
                          onClick={() => onDeleteTireMaintenance(record)}
...
export default TireMaintenanceTable;
